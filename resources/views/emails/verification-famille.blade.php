...
@php
    ...
    $t = [
        'fr' => [
            ...
            'currentInfo' => 'Vos informations actuelles :', 'name' => 'Nom complet', 'phone' => 'Téléphone',
            'address' => 'Adresse', 'adults' => "Nombre d'adultes", 'children' => "Nombre d'enfants",
            'question' => 'Vos informations sont-elles toujours correctes ?',
            'buttonUpToDate' => '✅ Tout est à jour', 'buttonChanged' => '📝 Mes informations ont changé',
        ],
        'ar' => [
            'greeting' => 'مرحبا', 'intro' => 'نأمل أن تكون بخير. كجزء من متابعتنا، نود التحقق من أن معلوماتك لا تزال محدثة.',
            'currentInfo' => 'معلوماتك الحالية:', 'name' => 'الاسم الكامل', 'phone' => 'الهاتف',
            'address' => 'العنوان', 'adults' => 'عدد البالغين', 'children' => 'عدد الأطفال',
            'question' => 'هل معلوماتك لا تزال صحيحة؟',
            'buttonUpToDate' => '✅ كل شيء محدث', 'buttonChanged' => '📝 تغيرت معلوماتي',
        ],
        'en' => [
            ...
            'currentInfo' => 'Your current information:', 'name' => 'Full name', 'phone' => 'Phone',
            'address' => 'Address', 'adults' => 'Number of adults', 'children' => 'Number of children',
            'question' => 'Is your information still correct?',
            'buttonUpToDate' => '✅ Everything is up to date', 'buttonChanged' => '📝 My information has changed',
        ],
    ][$langue];
@endphp
<!DOCTYPE html>
