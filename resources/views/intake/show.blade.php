    ...
    <header class="bg-sidebar py-6 px-4">
        <div class="max-w-2xl mx-auto flex items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <img src="{{ asset('images/amana-logo.png') }}" alt="AMANA" class="w-11 h-11 rounded-full object-cover flex-shrink-0">
                <div>
                    <div class="font-heading text-white font-semibold text-[15px] leading-tight">AMANA</div>
                    <div class="text-white/45 text-[11.5px]">Demande d'aide — Zakat El Fitr / Sadaqa</div>
                </div>
            </div>
