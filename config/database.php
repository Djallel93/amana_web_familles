...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // (voir amana/shared). amana_web_familles n'a plus de migrations
        // ni de modèles pour ref_personnes/ref_roles/ref_applications/
        // ref_settings/audit_logs — tout vient de cette connexion.
        'commun' => [
            'driver' => 'mysql',
